class EditMap {
	...
	detectTagging() {
		var that = this;
		$(document.getElementById('commentEntry_ifr').contentWindow.document).keyup(function (e) {
			...
			if (that.writing == true) {
				...
				if (e.originalEvent.target.innerText=="@alan"){
					...
					content = content.replace("@alan", '<span data-userid="1" style="color:red;">@alan</span>');
