...
<link rel="stylesheet" href="https://unpkg.com/leaflet@1.6.0/dist/leaflet.css"
  ...
  crossorigin="anonymous"></script>
	...
	<div id="titleContainer"><h4>2021 BICCS & WITT Eligibility</h4></div>
    ...
    <div id="layerGroupSelector">
	 ...
	 <script>
	  ...
	  $(document).ready(function() {// load document
		  ...
		  this.editable = false,
		  this.mapOptions = {center: new L.LatLng(49.164511, -122.863108), zoom: 10, crs:L.CRS.EPSG3857, zoomControl: false , minZoom: 10, maxZoom: 15},
		  this.token = token,
		  ...
		  this.featureGrouping = [{"displayName": "Urban Centres",
