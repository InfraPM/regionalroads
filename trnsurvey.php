...
<!--	    <a href="index.php" class="headerlink btn btn-primary btn-block btn-large" style="clear:right">< Return to Data</a>-->
    ...
    <div id="trnlegend"><img src="<?php echo $baseURL; ?>regionalroads.com/img/trnreviewlegend.png" style="width:300px;"></div>
...
//var namespace = "dev";
    ...
    //var mapCRS = new L.Proj.CRS("EPSG:4326");
    var osowHeightLayer = L.tileLayer.betterWms(baseAPIURL +'/wms/?', {
	layers: osowHeight,
	query_layers: osowHeight,
	token: token,
	format: 'image/png',
	transparent: 'true',
	tiled:'true',
    ...
    var osowWeightLayer = L.tileLayer.betterWms(baseAPIURL +'/wms/?', {
	layers: osowWeight,
	query_layers: osowWeight,
	token: token,
	format: 'image/png',
	transparent: 'true',
	tiled:'true',
    ...
    var osowWidthLayer = L.tileLayer.betterWms(baseAPIURL +'/wms/?', {
	layers: osowWidth,
	query_layers: osowWidth,
	token: token,
	format: 'image/png',
	transparent: 'true',
	tiled:'true',
    ...
    var termPermitLayer = L.tileLayer.betterWms(baseAPIURL +'/wms/?', {
	layers: termPermit,
	query_layers: termPermit,
	token: token,
	format: 'image/png',
	transparent: 'true',
	tiled:'true',
    ...
    var layerControl = {"MRN Survey (675 km)": mrnLayer,
			"TRN Survey (110 km)": trnSurveyLayer,
"Provincial/Federal Survey (92 km)": provincialLayerGroup,
"Municipal Survey (14 km)": municipalLayerGroup,			
			"Pre-screened Over-height Route":osowHeightLayer,
			"Pre-screened Overweight Route":osowWeightLayer,
			"Pre-screened Over-width Route":osowWidthLayer,
			"Term Permit Route": termPermitLayer,
			"Overhead Structure": overheadObstructionsLayer,
			"Provincial Highway": provincialHighwayLayer
		       };
